...
To create a survey:
$ ./temp_example_client.py create --owner_email <email1> <email2> \
    --client_secrets_file <file>

To start the survey:
$ ./temp_example_client.py start --survey_id <id> --client_secrets_file <file>

To download survey results:
$ ./temp_example_client.py fetch --survey_id <id> --results_file=~/my_results.xls \
    --client_secrets_file <file>
